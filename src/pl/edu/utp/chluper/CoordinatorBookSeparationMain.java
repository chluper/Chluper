 ...
 * @author kinga
 */
public class CoordinatorBookSeparationMain {
...
//        List<Integer> librarySizeList = Arrays.asList(new Integer[]{2, 3, 4, 5});
...
//        List<Class> algorithmList = Arrays.asList(new Class[]{SimpleAlgorithm.class});
        ...
        List<Integer> librarySizeList = Arrays.asList(new Integer[]{4});
        List<Integer> desksNumber = Arrays.asList(new Integer[]{5, 6});
        List<Integer> robotsNumber = Arrays.asList(new Integer[]{1, 2, 3});
        List<Integer> cacheLimit = Arrays.asList(new Integer[]{1, 2, 3});
        List<Class> algorithmList = Arrays.asList(new Class[]{SimpleAlgorithm.class});
    ...
    public static void create(int librarySize, int desksNumber, int robotsNumber, int cacheLimit) throws IOException {
        ...
        save(SimpleCoordintatedAlgorithBookSeparation.class.getSimpleName(), s);
    }
